...
const user23 = { name: "Sagar", email: "sagar@example.com" };
const admin = { name: "Admin", permissions: ["Manage Users", "Edit Content"] };
...
const myDog3 = { breed: "Labrador" };
const myCat3 = { color: "Black" };
